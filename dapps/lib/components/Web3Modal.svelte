...
<p class="subtitle">
  Simple example to using the <a href="https://web3modal.com/">Web3Modal</a> library
  to connect the default store.
</p>
...
{#if $web3.version}
  <div class="buttons">
    <button class="button is-link is-light" on:click={enable}
      >connect using Web3Modal</button
    >
  </div>
{/if}
...
{#if $web3.version}
  <div class="buttons">
    <button class="button is-link is-light" on:click={disable}
      >disconnect</button
    >
  </div>
{/if}
